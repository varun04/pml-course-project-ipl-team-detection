...
Reads the saved model_group_18_varun.pkl, takes any 800x600 image, returns
...
Usage as a library:
    ...
    model = load_model('models/model_group_18_varun.pkl')
...
MODEL_PATH_DEFAULT = REPO_ROOT / "models" / "model_group_18_varun.pkl"
...
def predict_image(model_payload, img_bgr: np.ndarray) -> list[int]:
    ...
    preds = model_payload["model"].predict(X_in)
